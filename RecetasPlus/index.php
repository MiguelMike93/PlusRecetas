...
<h2 class="text-center wowload fadeInUp">RecetasPlus</h2>  
  ...
  <div class="col-sm-6 wowload fadeInLeft">
    <h4><i class="fa fa-camera-retro"></i> ¡Hola! </h4>
    <p>Recetas plus es una aplicación diseñada para aquellos usuarios que quieren aprender a cocinar, sin necesidad de esas engorrosas recetas, que solo confunden a los usuarios.</p>
        <p>Aquí podrás encontrar gran cantidad de recetas faciles de implementar en casa. Por otro lado podrás comentar recetas de otros usuarios y asi mismo, enviar tus propias recetas.</p> 
